...
const assets = [
	...
	'./js/Sidebar.Geometry.PropGeometry.js',
	'./js/Sidebar.Geometry.WingGeometry.js',

	'./js/Sidebar.Material.js',
	'./js/Sidebar.Animation.js',
	'./js/Sidebar.Script.js',
	'./js/Sidebar.History.js',
	'./js/Sidebar.Condition.js',
	'./js/Sidebar.Analysis.js',
	'./js/MU.js',
	'./js/Strings.js',
	'./js/Toolbar.js',
	'./js/Viewport.js',
