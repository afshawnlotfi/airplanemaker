...
from aura_props.props import PropertyNode
import aura_props.props_xml as props_xml
import aura_props.props_json as props_json
...
class CreatorUI(QWidget):
    ...
    def build_detail(self):
        ...
        try:
            ...
            build = Builder(design, fileroot=self.fileroot, airfoil_resample=1000,
                            circle_points=32, nest_speed="nice")
        except Exception as e:
            reply = QMessageBox.question(self, "Error", "Error in building" , QMessageBox.Ok)
            print(e)
        QApplication.restoreOverrideCursor()
    ...
    def view3d(self):
        ...
        if result == None:
            ...
            viewer = os.path.abspath("/usr/bin/osgviewer")
